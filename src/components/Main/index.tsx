		...
		<main className="min-h-screen w-full bggreen graph-paper select-none">
			...
			<section className="border-b border-black hscreen min-h-screen w-full text-7xl flex items-center justify-center px-10 md:px-24 md:h-screen p-10">
				<section className=" flex flex-col items-start justify-center flex-[2]  md:px-10 md:border-x border-black min-h-screen">
					<h1 className="font-filgen text-center md:text-7xl text-6xl">About Us</h1>
					<section className="flex flex-col gap-y-2 text-lg font-light">
						<p>
							<span className="font-bold font-glb">:bitspace </span>🌟 is an innovative organization by
							design. We thrive on <span className="font-bold">empowering</span> young coders to
							showcase their skills through transformative
							open-source projects.
						</p>
						<p>
							We champion a culture of <span className="font-bold">open collaboration </span>and 
							<span className="font-bold"> knowledge sharing</span>, encouraging the creation of
							cutting-edge technology solutions that uplift the
							global community. ✨
						</p>
						<p>
							Our mission 🚀 is to offer enriching learning
							experiences and invaluable resources, sparking
							<span className="font-bold"> inspiration </span>in the next generation of software
							developers and entrepreneurs.
						</p>
						<p>
							At the heart of :bitspace 🩷 is a passionate team
							that values <span className="font-bold"> quality,  transparency, and
							accountability. </span>We’re a community-driven
							organization perfect for developers at any stage of
							their journey💥.
						</p>
					</section>
				...
				{/*
<section className="flex items-center border-x-8 border-accent">
					<h1 className=" font-glb text-[300px] leading-none">
						WE
					</h1>
					<section className="font-glb ">
						<h1>Learn.</h1>
						<h1>Collabrate.</h1>
						<h1>Grow.</h1>
					</section>
