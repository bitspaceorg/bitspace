"use client";
import GeneralTeam from "@/components/GenTeam";
      ...
      <main className="flex flex-col justify-center items-center pt-16 lg:px-8 lg:pt-5 bg-cream">
        <section className="hscreen flex flex-col w-full lg:w-[900px] px-2 select-none">
          ...
          <section className="flex flex-col space-y-2">
            <Team name="Rahul M Navneeth" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" />
            <Team name="Aswath T" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" />
            <Team name="Srivatav Auswin" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" />
            <Team name="Bharath Sanjeevi" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" />
            <Team name="Naveen Prem" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" /> 
            <Team name="Mukesh Kannan" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" />
            <Team name="Ravi Prasath" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" />
            <Team name="Albert Richard" github="@rahul_m_navneeth" linkedin="@rahul_m_navneeth" designation="president" />
          </section>
          <section className="grid grid-cols-2 lg:grid-cols-4 space-y-5 py-10">
            <GeneralTeam linkedin="" github="" name="Nadeem"/>
            <GeneralTeam linkedin="" github="" name="PSP"/>
            <GeneralTeam linkedin="" github="" name="Loghadick"/>
            <GeneralTeam linkedin="" github="" name="Simran"/>
            <GeneralTeam linkedin="" github="" name="walan"/>
            <GeneralTeam linkedin="" github="" name="Ajay"/>
            <GeneralTeam linkedin="" github="" name="Dhoni"/>
            <GeneralTeam linkedin="" github="" name="Fahad"/>
          </section>
        </section>

        <section className="block p-95">
