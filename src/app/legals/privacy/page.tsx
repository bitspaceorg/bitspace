    ...
    return (
        <section className="py-24">
            ...
            <div className="px-12 md:px-24 mt-12 mb-4" id="overview">
                ...
                <P>Bitspace is a dynamic and innovative organization that provides a platform for young and talented coders to showcase their skills by creating and contributing to open-source projects. We know, and understand the importance of privacy and security, and we assure that we DO NOT collect any information without the user's consent, and we NEITHER have the intention NOR the implementation to share any of the information illegally.</P>
            </div>
